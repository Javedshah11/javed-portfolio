                ...
                <div className="relative mt-6 grid min-h-64 place-items-center overflow-hidden rounded-3xl border border-cyan-300/20 bg-slate-950">
                  ...
                  {project.previewImages?.length ? (
                      ...
                      {project.previewImages.map((image, imageIndex) => (
                        ...
                        >
                          <img
                            ...
                            className="aspect-[16/10] w-full rounded-2xl border border-white/10 object-cover shadow-2xl shadow-black/40"
                            loading="lazy"
                          />
                        </div>
                      ))}
                    ...
                    <>
                      ...
                      <div className="relative w-[82%] rounded-2xl border border-white/10 bg-white/[0.06] p-4 shadow-2xl shadow-cyan-950/30">
                        <div className="flex items-center justify-between gap-3">
                          <div className="h-3 w-24 rounded-full bg-cyan-200/70" />
                          <div className="h-7 w-20 rounded-full bg-violet-300/30" />
                        </div>
